...
namespace Shitty\ORM\Tools\Pagination;

use Shitty\DBAL\Platforms\DB2Platform;
use Shitty\DBAL\Platforms\OraclePlatform;
use Shitty\DBAL\Platforms\PostgreSqlPlatform;
use Shitty\DBAL\Platforms\SQLAnywherePlatform;
use Shitty\DBAL\Platforms\SQLServerPlatform;
use Shitty\ORM\Query\AST\ArithmeticExpression;
use Shitty\ORM\Query\AST\ArithmeticFactor;
use Shitty\ORM\Query\AST\ArithmeticTerm;
use Shitty\ORM\Query\AST\Literal;
use Shitty\ORM\Query\AST\OrderByClause;
use Shitty\ORM\Query\AST\OrderByItem;
use Shitty\ORM\Query\AST\PartialObjectExpression;
use Shitty\ORM\Query\AST\PathExpression;
use Shitty\ORM\Query\AST\SelectExpression;
use Shitty\ORM\Query\AST\SimpleArithmeticExpression;
use Shitty\ORM\Query\Expr\OrderBy;
use Shitty\ORM\Query\Expr\Select;
use Shitty\ORM\Query\SqlWalker;
use Shitty\ORM\Query\AST\SelectStatement;
...
{
    /**
     * @var \Shitty\DBAL\Platforms\AbstractPlatform
     */
    private $platform;

    /**
     * @var \Shitty\ORM\Query\ResultSetMapping
     */
    private $rsm;
     ...
     * The quote strategy.
     *
     * @var \Shitty\ORM\Mapping\QuoteStrategy
     */
     ...
     * accessors.
     *
     * @param \Shitty\ORM\Query              $query
     * @param \Shitty\ORM\Query\ParserResult $parserResult
     ...
     * @return string
     *
     * @throws \Shitty\ORM\OptimisticLockException
