...
class ManyToManyBidirectionalAssociationTest extends AbstractManyToManyAssociationTestCase
{
    ...
    protected function _findCategories()
    {
        ...
        $result = $query->getResult();
        self::assertEquals(2, count($result));
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceCategory', $result[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceCategory', $result[1]);
    ...
    public function assertLazyLoadFromInverseSide($products)
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceProduct', $firstCategoryProducts[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceProduct', $firstCategoryProducts[1]);
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceProduct', $secondCategoryProducts[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceProduct', $secondCategoryProducts[1]);
    ...
    public function assertLazyLoadFromOwningSide($categories)
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceCategory', $firstProductCategories[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceCategory', $firstProductCategories[1]);
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceCategory', $secondProductCategories[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceCategory', $secondProductCategories[1]);
