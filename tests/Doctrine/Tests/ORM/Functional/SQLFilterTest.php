...
class SQLFilterTest extends \Doctrine\Tests\OrmFunctionalTestCase
{
    ...
    public function testEntityManagerEnableFilter()
    {
        ...
        self::assertTrue($filter instanceof \Doctrine\Tests\ORM\Functional\MyLocaleFilter);
    ...
    public function testEntityManagerEnabledFilters()
    {
        ...
        // No enabled filters
        self::assertEquals(array(), $em->getFilters()->getEnabledFilters());
    ...
    public function testQueryCache_DependsOnFilters()
    {
        ...
        $query->getResult();
        self::assertEquals(1, sizeof($cacheDataReflection->getValue($cache)));
        ...
        $query->getResult();
        self::assertEquals(2, sizeof($cacheDataReflection->getValue($cache)));
    ...
    public function testRepositoryFind()
    {
        ...
        self::assertNotNull($this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->find($this->groupId));
        self::assertNotNull($this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->find($this->groupId2));

        $this->useCMSGroupPrefixFilter();
        $this->_em->clear();

        self::assertNotNull($this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->find($this->groupId));
        self::assertNull($this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->find($this->groupId2));
    }
    ...
    public function testRepositoryFindAll()
    {
        ...
        self::assertCount(2, $this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->findAll());

        $this->useCMSGroupPrefixFilter();
        $this->_em->clear();

        self::assertCount(1, $this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->findAll());
    }
    ...
    public function testRepositoryFindBy()
    {
        ...
        self::assertCount(1, $this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->findBy(array('id' => $this->groupId2)));

        $this->useCMSGroupPrefixFilter();
        $this->_em->clear();

        self::assertCount(0, $this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->findBy(array('id' => $this->groupId2)));
    }
    ...
    public function testRepositoryFindByX()
    {
        ...
        self::assertCount(1, $this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->findById($this->groupId2));

        $this->useCMSGroupPrefixFilter();
        $this->_em->clear();

        self::assertCount(0, $this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->findById($this->groupId2));
    }
    ...
    public function testRepositoryFindOneBy()
    {
        ...
        self::assertNotNull($this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->findOneBy(array('id' => $this->groupId2)));

        $this->useCMSGroupPrefixFilter();
        $this->_em->clear();

        self::assertNull($this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->findOneBy(array('id' => $this->groupId2)));
    }
    ...
    public function testRepositoryFindOneByX()
    {
        ...
        self::assertNotNull($this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->findOneById($this->groupId2));

        $this->useCMSGroupPrefixFilter();
        $this->_em->clear();

        self::assertNull($this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')->findOneById($this->groupId2));
    }
    ...
    public function testJoinSubclassPersister_FilterOnlyOnRootTableWhenFetchingSubEntity()
    {
        ...
        // Persister
        self::assertEquals(2, count($this->_em->getRepository('Doctrine\Tests\Models\Company\CompanyManager')->findAll()));
        // SQLWalker
    ...
    {
        $this->loadCompanyJoinedSubclassFixtureData();
        self::assertEquals(3, count($this->_em->getRepository('Doctrine\Tests\Models\Company\CompanyPerson')->findAll()));
    ...
    public function testSingleTableInheritance_FilterOnlyOnRootTableWhenFetchingSubEntity()
    {
        ...
        // Persister
        self::assertEquals(2, count($this->_em->getRepository('Doctrine\Tests\Models\Company\CompanyFlexUltraContract')->findAll()));
        // SQLWalker
        ...
        self::assertEquals(1, count($this->_em->getRepository('Doctrine\Tests\Models\Company\CompanyFlexUltraContract')->findAll()));
    ...
    {
        $this->loadCompanySingleTableInheritanceFixtureData();
        self::assertEquals(4, count($this->_em->getRepository('Doctrine\Tests\Models\Company\CompanyFlexContract')->findAll()));
        ...
        self::assertEquals(2, count($this->_em->getRepository('Doctrine\Tests\Models\Company\CompanyFlexContract')->findAll()));
