...
class QueryTest extends OrmFunctionalTestCase
{
    ...
    public function testIterateResult_IterativelyBuildUpUnitOfWork()
    {
        ...
        self::assertEquals(array("Doctrine 2", "Symfony 2"), $topics);
    ...
    public function testEntityParameters()
    {
        ...
        $result = $q->getResult();
        self::assertEquals(1, count($result));
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsArticle', $result[0]);
        self::assertEquals("dr. dolittle", $result[0]->topic);
        self::assertInstanceOf('Doctrine\ORM\Proxy\Proxy', $result[0]->user);
    ...
    public function testEnableFetchEagerMode()
    {
        ...
        foreach ($articles AS $article) {
            self::assertNotInstanceOf('Doctrine\ORM\Proxy\Proxy', $article);
        }
    }
    ...
    public function testgetOneOrNullResult()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $fetchedUser);
    ...
    public function testSetCollectionParameterBindingSingleIdentifierObject()
    {
        ...
        self::assertEquals(3, count($users));
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $users[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $users[1]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $users[2]);
    ...
    public function testMultipleJoinComponentsUsingInnerJoin()
    {
        ...
        self::assertEquals(2, count($users));
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $users[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsPhonenumber', $users[1]);
    }
