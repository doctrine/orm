...
class NativeQueryTest extends \Doctrine\Tests\OrmFunctionalTestCase
{
    ...
    public function testJoinedOneToManyNativeQuery()
    {
        ...
        self::assertEquals('Roman', $users[0]->name);
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $users[0]->getPhonenumbers());
    ...
    public function testJoinedOneToOneNativeQueryWithRSMBuilder()
    {
        ...
        $rsm->addRootEntityFromClassMetadata(CmsUser::class, 'u');
        $rsm->addJoinedEntityFromClassMetadata(CmsAddress::class, 'a', 'u', 'address', array('id' => 'a_id'));
    ...
    public function testUnknownParentAliasThrowsException()
    {
        ...
        $rsm->addRootEntityFromClassMetadata(CmsUser::class, 'u');
        $rsm->addJoinedEntityFromClassMetadata(CmsAddress::class, 'a', 'un', 'address', array('id' => 'a_id'));
    ...
    public function testBasicNativeNamedQueryWithSqlResultSetMapping()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddress', $result[0]);
    ...
    public function testBasicNativeNamedQueryWithResultClass()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsEmail', $result[0]->email);
    }
    ...
    public function testJoinedOneToOneNativeNamedQueryWithResultSetMapping()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[0]);
        self::assertEquals('Fabio B. Silva', $result[0]->name);
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $result[0]->getPhonenumbers());
        self::assertFalse($result[0]->getPhonenumbers()->isInitialized());
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddress', $result[0]->getAddress());
    ...
    public function testMixedNativeNamedQueryNormalJoin()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[1][0]);
    ...
    public function testNativeNamedQueryInheritance()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\Company\CompanyEmployee', $result[1]);
    ...
    public function testMultipleEntityResults()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[0][0]);
        self::assertEquals('Fabio B. Silva', $result[0][0]->name);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddress', $result[0][0]->getAddress());
    ...
    public function testNamedNativeQueryInheritance()
    {
        ...
        self::assertEquals('Doctrine\Tests\Models\Company\CompanyContract', $contractQueries['all-contracts']['resultClass']);

        self::assertEquals('all', $contractQueries['all']['name']);
        self::assertEquals('Doctrine\Tests\Models\Company\CompanyContract', $contractQueries['all']['resultClass']);


        // flex contract queries
        self::assertEquals('all-contracts', $flexQueries['all-contracts']['name']);
        self::assertEquals('Doctrine\Tests\Models\Company\CompanyFlexContract', $flexQueries['all-contracts']['resultClass']);

        self::assertEquals('all-flex', $flexQueries['all-flex']['name']);
        self::assertEquals('Doctrine\Tests\Models\Company\CompanyFlexContract', $flexQueries['all-flex']['resultClass']);

        self::assertEquals('all', $flexQueries['all']['name']);
        self::assertEquals('Doctrine\Tests\Models\Company\CompanyFlexContract', $flexQueries['all']['resultClass']);


        // contract result mapping
        self::assertEquals('mapping-all-contracts', $contractMappings['mapping-all-contracts']['name']);
        self::assertEquals('Doctrine\Tests\Models\Company\CompanyContract', $contractMappings['mapping-all-contracts']['entities'][0]['entityClass']);
        ...
        self::assertEquals('Doctrine\Tests\Models\Company\CompanyFlexContract', $flexMappings['mapping-all-contracts']['entities'][0]['entityClass']);

        self::assertEquals('mapping-all', $flexMappings['mapping-all']['name']);
        self::assertEquals('Doctrine\Tests\Models\Company\CompanyFlexContract', $flexMappings['mapping-all']['entities'][0]['entityClass']);

        self::assertEquals('mapping-all-flex', $flexMappings['mapping-all-flex']['name']);
        self::assertEquals('Doctrine\Tests\Models\Company\CompanyFlexContract', $flexMappings['mapping-all-flex']['entities'][0]['entityClass']);
