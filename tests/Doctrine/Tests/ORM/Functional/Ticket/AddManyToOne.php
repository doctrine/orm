 ...
 */
class AddManyToOne extends \Doctrine\Tests\OrmFunctionalTestCase
{
    public function testIssue()
    {
        $driver = new StaticPHPDriver(__DIR__ . '/../../../Models/AddManyToOne/');
        $this->_em->getConfiguration()->setMetadataDriverImpl($driver);

        $sql = $this->_schemaTool->getCreateSchemaSql(array(
            $this->_em->getClassMetadata('Doctrine\Tests\Models\AddManyToOne\User'),
