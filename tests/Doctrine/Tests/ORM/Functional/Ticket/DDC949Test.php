...
class DDC949Test extends OrmFunctionalTestCase
{
    ...
    public function testBooleanThroughRepository()
    {
        ...
        $true = $this->_em->getRepository('Doctrine\Tests\Models\Generic\BooleanModel')->findOneBy(
            ['booleanField' => true]
        );
        $false = $this->_em->getRepository('Doctrine\Tests\Models\Generic\BooleanModel')->findOneBy(
            ['booleanField' => false]
        );
