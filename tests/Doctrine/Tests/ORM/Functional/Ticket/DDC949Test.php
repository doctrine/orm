...
class DDC949Test extends OrmFunctionalTestCase
{
    ...
    public function testBooleanThroughRepository()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\Generic\BooleanModel', $true, "True model not found");
        self::assertTrue($true->booleanField, "True Boolean Model should be true.");

        self::assertInstanceOf('Doctrine\Tests\Models\Generic\BooleanModel', $false, "False model not found");
