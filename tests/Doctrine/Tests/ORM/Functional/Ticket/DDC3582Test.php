...
class DDC3582Test extends \Doctrine\Tests\OrmFunctionalTestCase
{
    function testNestedEmbeddablesAreHydratedWithProperClass()
    {
        ...
        self::assertInstanceOf(DDC3582Embeddable1::CLASSNAME, $entity->embeddable1);
        self::assertInstanceOf(DDC3582Embeddable2::CLASSNAME, $entity->embeddable1->embeddable2);
        self::assertInstanceOf(DDC3582Embeddable3::CLASSNAME, $entity->embeddable1->embeddable2->embeddable3);
    }
}
