...
class CascadeRemoveOrderTest extends \Doctrine\Tests\OrmFunctionalTestCase
{
    ...
    public function testSingle()
    {
        ...
        $eOloaded = $this->_em->find('Doctrine\Tests\ORM\Functional\Ticket\CascadeRemoveOrderEntityO', $eO->getId());
...
class CascadeRemoveOrderEntityO
{
    ...
    /**
     * @OneToMany(targetEntity="Doctrine\Tests\ORM\Functional\Ticket\CascadeRemoveOrderEntityG", mappedBy="ownerO", cascade={"persist", "remove"})
     **/
    private $oneToManyG;
...
class CascadeRemoveOrderEntityG
{
    ...
    /**
     * @ManyToOne(targetEntity="Doctrine\Tests\ORM\Functional\Ticket\CascadeRemoveOrderEntityO", inversedBy="oneToMany")
     **/
    private $ownerO;
