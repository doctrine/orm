...
class DDC2862Test extends \Doctrine\Tests\OrmFunctionalTestCase
{
    ...
    public function testIssue()
    {
        ...
        self::assertTrue($this->_em->getCache()->containsEntity(DDC2862User::CLASSNAME, array('id' => $user1->getId())));
        self::assertTrue($this->_em->getCache()->containsEntity(DDC2862Driver::CLASSNAME, array('id' => $driver1->getId())));

        $queryCount = $this->getCurrentQueryCount();
        $driver2    = $this->_em->find(DDC2862Driver::CLASSNAME, $driver1->getId());

        self::assertEquals($queryCount, $this->getCurrentQueryCount());
        self::assertInstanceOf(DDC2862Driver::CLASSNAME, $driver2);
        self::assertInstanceOf(DDC2862User::CLASSNAME, $driver2->getUserProfile());
        ...
        self::assertEquals($queryCount, $this->getCurrentQueryCount());
        self::assertInstanceOf(DDC2862Driver::CLASSNAME, $driver3);
        self::assertInstanceOf(DDC2862User::CLASSNAME, $driver3->getUserProfile());
    ...
    public function testIssueReopened()
    {
        ...
        self::assertFalse($this->_em->getCache()->containsEntity(DDC2862User::CLASSNAME, array('id' => $user1->getId())));
        self::assertFalse($this->_em->getCache()->containsEntity(DDC2862Driver::CLASSNAME, array('id' => $driver1->getId())));
        ...
        self::assertInstanceOf(DDC2862Driver::CLASSNAME, $driver4);
        self::assertInstanceOf(DDC2862User::CLASSNAME, $driver4->getUserProfile());
        self::assertEquals($queryCount, $this->getCurrentQueryCount());
