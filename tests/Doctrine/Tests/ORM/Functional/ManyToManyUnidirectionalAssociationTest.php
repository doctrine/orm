...
class ManyToManyUnidirectionalAssociationTest extends AbstractManyToManyAssociationTestCase
{
    ...
    public function testEagerLoad()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceProduct', $products[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceProduct', $products[1]);
