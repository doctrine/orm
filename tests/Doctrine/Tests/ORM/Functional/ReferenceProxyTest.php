...
class ReferenceProxyTest extends OrmFunctionalTestCase
{
    ...
    public function testAccessMetatadaForProxy()
    {
        ...
        self::assertEquals('Doctrine\Tests\Models\ECommerce\ECommerceProduct', $class->name);
    }
    ...
    public function testCommonPersistenceProxy()
    {
        ...
        self::assertInstanceOf('Doctrine\Common\Persistence\Proxy', $entity);
        self::assertFalse($entity->__isInitialized());
        self::assertEquals('Doctrine\Tests\Models\ECommerce\ECommerceProduct', $className);
