...
use Doctrine\Tests\Models\CMSCustomId\CmsArticle;
use Doctrine\Tests\Models\CMSCustomId\CmsEmail;
use Doctrine\Tests\Models\CMSCustomId\CmsGroup;
use Doctrine\Tests\Models\CMSCustomId\CmsUser;
 ...
 * @group DDC-1613
 */
class PaginationCustomTypeIdTest extends OrmFunctionalTestCase
{
    protected function setUp()
    {
        $this->useModelSet('cmscustomid');
    ...
    {
        $dql = 'SELECT u,g FROM Doctrine\Tests\Models\CMSCustomId\CmsUser u JOIN u.groups g';
        $query = $this->_em->createQuery($dql);
    ...
    {
        $dql = 'SELECT g, COUNT(u.id) AS userCount FROM Doctrine\Tests\Models\CMSCustomId\CmsGroup g LEFT JOIN g.users u GROUP BY g HAVING COUNT(u.id) > 0';
        $query = $this->_em->createQuery($dql);
    ...
    {
        // Ascending
        $dql = 'SELECT u FROM Doctrine\Tests\Models\CMSCustomId\CmsUser u ORDER BY u.username';
    ...
    {
        $dql = 'SELECT u,g FROM Doctrine\Tests\Models\CMSCustomId\CmsUser u JOIN u.groups g ORDER BY u.username';
    ...
    {
        $dql = 'SELECT u FROM Doctrine\Tests\Models\CMSCustomId\CmsUser u JOIN u.email e ORDER BY e.email';
        $this->iterateWithOrderAsc($useOutputWalkers, $fetchJoinCollection, $dql, "username");
        $this->iterateWithOrderDesc($useOutputWalkers, $fetchJoinCollection, $dql, "username");
    }
    ...
    {
        $dql = 'SELECT u,g,e FROM Doctrine\Tests\Models\CMSCustomId\CmsUser u JOIN u.groups g JOIN u.email e ORDER BY e.email';
        $this->iterateWithOrderAsc($useOutputWalkers, true, $dql, "username");
        $this->iterateWithOrderDesc($useOutputWalkers, true, $dql, "username");
    }
    ...
    public function testCountQueryStripsParametersInSelect()
    {
        $query = $this->_em->createQuery(
            ...
            FROM Doctrine\\Tests\\Models\\CMSCustomId\\CmsUser u
        ...
        $query = $this->_em->createQuery(
            "SELECT u, 
                (
                    ...
                    FROM Doctrine\\Tests\\Models\\CMSCustomId\\CmsArticle a
                    WHERE a.user = u
