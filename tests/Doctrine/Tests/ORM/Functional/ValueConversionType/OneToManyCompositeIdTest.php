...
class OneToManyCompositeIdTest extends OrmFunctionalTestCase
{
    ...
    public function testThatEntitiesAreFetchedFromTheDatabase()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\ValueConversionType\InversedOneToManyCompositeIdEntity', $inversed);
        self::assertInstanceOf('Doctrine\Tests\Models\ValueConversionType\OwningManyToOneCompositeIdEntity', $owning);
    }
