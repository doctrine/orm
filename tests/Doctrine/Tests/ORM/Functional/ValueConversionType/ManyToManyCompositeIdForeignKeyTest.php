...
class ManyToManyCompositeIdForeignKeyTest extends OrmFunctionalTestCase
{
    ...
    public function testThatEntitiesAreFetchedFromTheDatabase()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\ValueConversionType\InversedManyToManyCompositeIdForeignKeyEntity', $inversed);
        self::assertInstanceOf('Doctrine\Tests\Models\ValueConversionType\OwningManyToManyCompositeIdForeignKeyEntity', $owning);
    }
