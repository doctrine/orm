...
class DetachedEntityTest extends OrmFunctionalTestCase
{
    ...
    public function testSerializeUnserializeModifyMerge()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $user->phonenumbers[0]->user);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $user->phonenumbers[1]->user);
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsPhonenumber', $phonenumbers[1]);
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsPhonenumber', $phonenumbers[0]);
    ...
    public function testUseDetachedEntityAsQueryParameter()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $newUser);
