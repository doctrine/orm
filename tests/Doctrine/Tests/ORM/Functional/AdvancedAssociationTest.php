...
class AdvancedAssociationTest extends \Doctrine\Tests\OrmFunctionalTestCase
{
    ...
    public function testIssue()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\ORM\Functional\PhraseType', $res[0]->getType());
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $res[0]->getType()->getPhrases());
        ...
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $definitions);
        self::assertInstanceOf('Doctrine\Tests\ORM\Functional\Definition', $definitions[0]);
    ...
    public function testManyToMany()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\ORM\Functional\Type', $types[0]);
    }
}
