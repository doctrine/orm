...
class NewOperatorTest extends \Doctrine\Tests\OrmFunctionalTestCase
{
    ...
    public function testShouldSupportsBasicUsage($hydrationMode)
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUserDTO', $result[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUserDTO', $result[1]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUserDTO', $result[2]);
    ...
    public function testShouldSupportMultipleNewOperators()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUserDTO', $result[0][0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUserDTO', $result[1][0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUserDTO', $result[2][0]);

        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddressDTO', $result[0][1]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddressDTO', $result[1][1]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddressDTO', $result[2][1]);
    ...
    public function testShouldSupportMultipleNewOperatorsWithAliases()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUserDTO', $result[0]['cmsUser']);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUserDTO', $result[1]['cmsUser']);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUserDTO', $result[2]['cmsUser']);

        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddressDTO', $result[0]['cmsAddress']);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddressDTO', $result[1]['cmsAddress']);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddressDTO', $result[2]['cmsAddress']);
    ...
    public function testShouldSupportMultipleNewOperatorsWithAndWithoutAliases()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddressDTO', $result[0][0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddressDTO', $result[1][0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddressDTO', $result[2][0]);
