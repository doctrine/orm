...
class ObjectHydratorTest extends HydrationTestCase
{
    ...
    public function testSimpleEntityQuery()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[1]);
    ...
    public function testSimpleEntityQueryWithAliasedUserEntity()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[0]['user']);

        self::assertArrayHasKey('user', $result[1]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[1]['user']);
    ...
    public function testSimpleMultipleRootEntityQuery()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsArticle', $result[1]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[2]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsArticle', $result[3]);
    ...
    public function testSimpleMultipleRootEntityQueryWithAliasedUserEntity()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsArticle', $result[1][0]);
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[2]['user']);
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsArticle', $result[3][0]);
    ...
    public function testSimpleMultipleRootEntityQueryWithAliasedArticleEntity()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[0][0]);
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsArticle', $result[1]['article']);
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[2][0]);
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsArticle', $result[3]['article']);
    ...
    public function testMixedQueryNormalJoin($userEntityKey)
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[0][$userEntityKey]);

        // second user => 1 phonenumber
        self::assertEquals(1, $result[1]['numPhones']);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[1][$userEntityKey]);
    }
    ...
    public function testMixedQueryFetchJoin($userEntityKey)
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[0][$userEntityKey]);
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $result[0][$userEntityKey]->phonenumbers);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsPhonenumber', $result[0][$userEntityKey]->phonenumbers[0]);

        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[1][$userEntityKey]);
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $result[1][$userEntityKey]->phonenumbers);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsPhonenumber', $result[0][$userEntityKey]->phonenumbers[1]);
    ...
    public function testMixedQueryFetchJoinCustomIndex($userEntityKey)
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[1][$userEntityKey]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[2][$userEntityKey]);
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $result[1][$userEntityKey]->phonenumbers);
    ...
    public function testMixedQueryMultipleFetchJoin($userEntityKey)
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsPhonenumber', $result[0][$userEntityKey]->phonenumbers[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsPhonenumber', $result[0][$userEntityKey]->phonenumbers[1]);
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $result[0][$userEntityKey]->articles);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsArticle', $result[0][$userEntityKey]->articles[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsArticle', $result[0][$userEntityKey]->articles[1]);

        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $result[1][$userEntityKey]);
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $result[1][$userEntityKey]->phonenumbers);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsPhonenumber', $result[1][$userEntityKey]->phonenumbers[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsArticle', $result[1][$userEntityKey]->articles[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsArticle', $result[1][$userEntityKey]->articles[1]);
    }
    ...
    public function testMixedQueryMultipleDeepMixedFetchJoin($userEntityKey)
    {
        ...
        // article comments
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $result[0][$userEntityKey]->articles[0]->comments);
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsComment', $result[0][$userEntityKey]->articles[0]->comments[0]);

        // empty comment collections
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $result[0][$userEntityKey]->articles[1]->comments);
        self::assertEquals(0, count($result[0][$userEntityKey]->articles[1]->comments));

        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $result[1][$userEntityKey]->articles[0]->comments);
        self::assertEquals(0, count($result[1][$userEntityKey]->articles[0]->comments));
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $result[1][$userEntityKey]->articles[1]->comments);
    ...
    public function testEntityQueryCustomResultSetOrder()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\Forum\ForumCategory', $result[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\Forum\ForumCategory', $result[1]);
    ...
    public function testCreatesProxyForLazyLoadingWithForeignKeys()
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceProduct', $result[0]);
    }
    ...
    public function testCreatesProxyForLazyLoadingWithForeignKeysWithAliasedProductEntity()
    {
        ...
        self::assertInternalType('array', $result[0]);
        self::assertInstanceOf('Doctrine\Tests\Models\ECommerce\ECommerceProduct', $result[0]['product']);
    }
    ...
    public function testResultIteration()
    {
        ...
        while (($row = $iterableResult->next()) !== false) {
            ...
            self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $row[0]);
    ...
    public function testResultIterationWithAliasedUserEntity()
    {
        ...
        while (($row = $iterableResult->next()) !== false) {
            ...
            self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsUser', $row[0]['user']);
    ...
    public function testManyToManyHydration()
    {
        ...
        self::assertContainsOnly('Doctrine\Tests\Models\CMS\CmsUser', $result);
    ...
    public function testMissingIdForSingleValuedChildEntity($userEntityKey)
    {
        ...
        self::assertInstanceOf('Doctrine\Tests\Models\CMS\CmsAddress', $result[0][$userEntityKey]->address);
    ...
    public function testFetchJoinCollectionValuedAssociationWithDefaultArrayValue()
    {
        ...
        self::assertInstanceOf(EntityWithArrayDefaultArrayValueM2M::CLASSNAME, $result[0]);
        self::assertInstanceOf('Doctrine\ORM\PersistentCollection', $result[0]->collection);
        self::assertCount(1, $result[0]->collection);
        self::assertInstanceOf(SimpleEntity::CLASSNAME, $result[0]->collection[0]);
    }
}
