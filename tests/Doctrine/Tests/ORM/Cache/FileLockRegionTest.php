...
class FileLockRegionTest extends AbstractRegionTest
{
    ...
    public function testLockAndUnlock()
    {
        ...
        self::assertInstanceOf('Doctrine\ORM\Cache\Lock', $lock);
    ...
    public function testUnlockWithExistingLock()
    {
        ...
        self::assertInstanceOf('Doctrine\ORM\Cache\Lock', $lock = $this->region->lock($key));
        self::assertEquals($lock->value, file_get_contents($file));
        self::assertFileExists($file);
    ...
    public function testLockedEvictAll()
    {
        ...
        self::assertInstanceOf('Doctrine\ORM\Cache\Lock', $lock1 = $this->region->lock($key1));
        self::assertInstanceOf('Doctrine\ORM\Cache\Lock', $lock2 = $this->region->lock($key2));
