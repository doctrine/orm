...
abstract class AbstractMappingDriverTest extends \Doctrine\Tests\OrmTestCase
{
    ...
    public function testSecondLevelCacheMapping()
    {
        ...
        $this->assertArrayHasKey('lifetime', $class->cache);
        ...
        $this->assertEquals(0, $class->cache['lifetime']);
        ...
        $this->assertArrayHasKey('lifetime', $class->associationMapping['state']['cache']);
        ...
        $this->assertEquals(0, $class->associationMappings['state']['cache']['lifetime']);
        ...
        $this->assertArrayHasKey('lifetime', $class->associationMappings['attractions']['cache']);
        ...
        $this->assertEquals(0, $class->associationMappings['attractions']['cache']['lifetime']);
    }
}
