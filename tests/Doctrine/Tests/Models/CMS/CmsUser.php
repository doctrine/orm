 ...
 *          query           = "SELECT id, name, status, phonenumber AS phone FROM cms_users INNER JOIN cms_phonenumbers ON id = user_id WHERE username = ?"
 *      ),
 *      @NamedNativeQuery(
 ...
 *                      @FieldResult("name"),
 *                      @FieldResult("status"),
 *                      @FieldResult("phonenumbers.phonenumber" , column = "phone"),
 *                  }
 *              )
 *          }
 *      ),
