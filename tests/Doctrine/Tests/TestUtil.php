...
class TestUtil
{
    ...
    private static function initializeDatabase(): void
    {
        ...
        // re-create Database in Oracle DB XE
        if ($platform instanceof OraclePlatform) {
            self::dropAllForOracle($testConn);
        } elseif ($platform->supportsCreateDropDatabase()) {
    ...
    public static function dropAllForOracle($connection) {
        $stmt = <<<SQL
BEGIN
