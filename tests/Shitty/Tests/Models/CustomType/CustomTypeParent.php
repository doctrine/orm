...
namespace Shitty\Tests\Models\CustomType;
...
class CustomTypeParent
{
    ...
    {
        $this->friendsWithMe = new \Shitty\Common\Collections\ArrayCollection();
        $this->myFriends = new \Shitty\Common\Collections\ArrayCollection();
    }
