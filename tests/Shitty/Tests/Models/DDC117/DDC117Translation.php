...
namespace Shitty\Tests\Models\DDC117;
...
class DDC117Translation
{
    ...
    public function __construct($article, $language, $title)
    {
        ...
        $this->title = $title;
        $this->reviewedByEditors = new \Shitty\Common\Collections\ArrayCollection();
        $this->lastTranslatedBy = new \Shitty\Common\Collections\ArrayCollection();
    }
