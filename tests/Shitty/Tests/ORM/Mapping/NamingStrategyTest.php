...
use Shitty\ORM\Mapping\UnderscoreNamingStrategy;
use Shitty\ORM\Mapping\DefaultNamingStrategy;
use Shitty\ORM\Mapping\NamingStrategy;
use Shitty\Tests\ORM\Mapping\NamingStrategy\JoinColumnClassNamingStrategy;

/**
 * @group DDC-559
 */
class NamingStrategyTest extends \Shitty\Tests\OrmTestCase
{
    /**
