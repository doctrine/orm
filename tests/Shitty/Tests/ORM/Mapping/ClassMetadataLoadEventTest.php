...
class ClassMetadataLoadEventTest extends \Shitty\Tests\OrmTestCase
{
    /**
     * @group DDC-1610
     */
    ...
    public function loadClassMetadata(\Shitty\ORM\Event\LoadClassMetadataEventArgs $eventArgs)
    {
