...
use Shitty\ORM\Id\AbstractIdGenerator;
...
class ClassMetadataFactoryTest extends \Shitty\Tests\OrmTestCase
{
    ...
    protected function _createValidClassMetadata()
    {
        ...
        $cm1->initializeReflection(new \Shitty\Common\Persistence\Mapping\RuntimeReflectionService);
