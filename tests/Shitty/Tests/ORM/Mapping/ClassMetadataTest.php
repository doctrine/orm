...
use Shitty\Common\Persistence\Mapping\StaticReflectionService;
...
class ClassMetadataTest extends \Shitty\Tests\OrmTestCase
{
    ...
    public function testSerializeManyToManyJoinTableCascade()
    {
        ...
        /* @var $assoc \Shitty\ORM\Mapping\ManyToManyMapping */
        $assoc = $cm->associationMappings['groups'];
    ...
    {
        $namingStrategy     = new \Shitty\ORM\Mapping\UnderscoreNamingStrategy(CASE_UPPER);
    ...
    /**
     * @expectedException \Shitty\ORM\Mapping\MappingException
