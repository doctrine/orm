...
class AnnotationDriverTest extends AbstractMappingDriverTest
{
    ...
    public function testLoadMetadataForNonEntityThrowsException()
    {
        ...
        $reader = new \Shitty\Common\Annotations\AnnotationReader(new \Shitty\Common\Cache\ArrayCache());
        $annotationDriver = new \Shitty\ORM\Mapping\Driver\AnnotationDriver($reader);
