...
use Shitty\Tests\Models\Company\CompanyFlexContract;
use Shitty\Tests\Models\Cache\City;
use Shitty\ORM\Mapping\ClassMetadata;
use Shitty\ORM\Mapping\ClassMetadataInfo;
use Shitty\Tests\Models\DDC2825\ExplicitSchemaAndTable;
use Shitty\Tests\Models\DDC2825\SchemaAndTableInTableName;

abstract class AbstractMappingDriverTest extends \Shitty\Tests\OrmTestCase
{
    ...
    public function createClassMetadata($entityClassName)
    {
        ...
        $class->initializeReflection(new \Shitty\Common\Persistence\Mapping\RuntimeReflectionService);
    ...
    protected function createClassMetadataFactory(\Shitty\ORM\EntityManager $em = null)
    {
        ...
        $factory    = new \Shitty\ORM\Mapping\ClassMetadataFactory();
    ...
    public function testNamingStrategy()
    {
        ...
        $em->getConfiguration()->setNamingStrategy(new \Shitty\ORM\Mapping\UnderscoreNamingStrategy(CASE_UPPER));
    ...
    {
        /* @var $metadata \Shitty\ORM\Mapping\ClassMetadata */
