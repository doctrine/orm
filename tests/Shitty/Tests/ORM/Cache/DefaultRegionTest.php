...
use Shitty\Tests\Mocks\CacheEntryMock;
use Shitty\Tests\Mocks\CacheKeyMock;
...
class DefaultRegionTest extends AbstractRegionTest
{
    ...
    public function testSharedRegion()
    {
        ...
        $region1 = new DefaultRegion('region1', new \Shitty\Common\Cache\ApcCache());
        $region2 = new DefaultRegion('region2', new \Shitty\Common\Cache\ApcCache());
    ...
    {
        /* @var $cache \Shitty\Common\Cache\Cache */
