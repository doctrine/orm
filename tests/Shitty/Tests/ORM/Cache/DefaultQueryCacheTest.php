...
namespace Shitty\Tests\ORM\Cache;

use Shitty\Tests\OrmTestCase;
use Shitty\Tests\Mocks\CacheRegionMock;
use Shitty\ORM\Cache\DefaultQueryCache;
use Shitty\ORM\Cache\QueryCacheKey;
use Shitty\ORM\Cache\QueryCacheEntry;
use Shitty\ORM\Query\ResultSetMappingBuilder;
...
{
    /**
     * @var \Shitty\ORM\Cache\DefaultQueryCache
     */
    private $queryCache;
    ...
    /**
     * @var \Shitty\Tests\Mocks\CacheRegionMock
     */
    private $region;

    /**
     * @var \Shitty\Tests\ORM\Cache\CacheFactoryDefaultQueryCacheTest
     */
...
class CacheFactoryDefaultQueryCacheTest extends \Shitty\ORM\Cache\DefaultCacheFactory
{
    private $queryCache;
    private $region;
