...
use Shitty\Tests\Mocks\EntityPersisterMock;
use Shitty\Tests\Mocks\UnitOfWorkMock;
use Shitty\Tests\Models\Forum\ForumAvatar;
use Shitty\Tests\Models\Forum\ForumUser;
use stdClass;

/**
 * UnitOfWork tests.
 */
class UnitOfWorkTest extends \Shitty\Tests\OrmTestCase
{
    /**
     * SUT
     *
    ...
    public function testGetEntityStateWithAssignedIdentity()
    {
        ...
        $ph = new \Shitty\Tests\Models\CMS\CmsPhonenumber();
        ...
        $this->assertFalse($persister->isExistsCalled());
        $ph2 = new \Shitty\Tests\Models\CMS\CmsPhonenumber();
