...
* @group performance
 */
class InheritancePersisterPerformanceTest extends \Shitty\Tests\OrmFunctionalTestCase
{
    ...
    {
        $person = new \Shitty\Tests\Models\Company\CompanyEmployee();
        ...
        for ($i = 0; $i < 33; $i++) {
            ...
            $flex = new \Shitty\Tests\Models\Company\CompanyFlexContract();
            ...
            $ultra = new \Shitty\Tests\Models\Company\CompanyFlexUltraContract();
