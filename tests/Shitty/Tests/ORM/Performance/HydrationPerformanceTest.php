...
use Shitty\Tests\Mocks\HydratorMockStatement,
    Shitty\ORM\Query\ResultSetMapping,
    Shitty\ORM\Query;
 ...
 * @group performance
 */
class HydrationPerformanceTest extends \Shitty\Tests\OrmPerformanceTestCase
{
    /**
    ...
    public function testSimpleQueryScalarHydrationPerformance10000Rows()
    {
        ...
        $hydrator = new \Shitty\ORM\Internal\Hydration\ScalarHydrator($this->_em);
    ...
    public function testSimpleQueryArrayHydrationPerformance10000Rows()
    {
        ...
        $stmt = new HydratorMockStatement($resultSet);
        $hydrator = new \Shitty\ORM\Internal\Hydration\ArrayHydrator($this->_em);
