...
use Shitty\Tests\Mocks\HydratorMockStatement;
...
use Shitty\Tests\Models\Hydration\EntityWithArrayDefaultArrayValueM2M;
use Shitty\Tests\Models\Hydration\SimpleEntity;
...
class ObjectHydratorTest extends HydrationTestCase
{
    ...
    public function testSimpleEntityQuery()
    {
        ...
        $hydrator = new \Shitty\ORM\Internal\Hydration\ObjectHydrator($this->_em);
    ...
    public function testCreatesProxyForLazyLoadingWithForeignKeys()
    {
        ...
        $proxyInstance = new \Shitty\Tests\Models\ECommerce\ECommerceShipping();
     ...
     * @group DDC-1470
     *
     * @expectedException \Shitty\ORM\Internal\Hydration\HydrationException
