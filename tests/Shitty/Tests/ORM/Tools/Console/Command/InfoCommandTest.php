...
class InfoCommandTest extends OrmFunctionalTestCase
{
    ...
    /**
     * @var \Shitty\ORM\Tools\Console\Command\InfoCommand
     */
    private $command;
