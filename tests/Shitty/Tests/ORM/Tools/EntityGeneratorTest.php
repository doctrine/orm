...
use Shitty\Tests\Models\DDC2372\DDC2372Admin;
use Shitty\Tests\Models\DDC2372\DDC2372User;
...
class EntityGeneratorTest extends OrmTestCase
{
    ...
    public function testGeneratedEntityClass()
    {
        ...
        $this->assertEquals(new \Shitty\Common\Collections\ArrayCollection(array($comment)), $book->getComments());
        $this->assertInternalType('boolean', $book->removeComment($comment));
        $this->assertEquals(new \Shitty\Common\Collections\ArrayCollection(array()), $book->getComments());
