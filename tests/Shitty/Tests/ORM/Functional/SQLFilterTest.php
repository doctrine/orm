...
use Shitty\ORM\Query\Filter\SQLFilter;
...
use Shitty\Tests\Models\Company\CompanyManager;
use Shitty\Tests\Models\Company\CompanyOrganization;
use Shitty\Tests\Models\Company\CompanyAuction;

use Shitty\Tests\Models\Company\CompanyFlexContract;
use Shitty\Tests\Models\Company\CompanyFlexUltraContract;
 ...
 * @group non-cacheable
 */
class SQLFilterTest extends \Shitty\Tests\OrmFunctionalTestCase
{
    ...
    public function testEntityManagerEnableFilter()
    {
        ...
        $this->assertTrue($filter instanceof \Shitty\Tests\ORM\Functional\MyLocaleFilter);
