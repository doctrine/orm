...
use Shitty\Common\Persistence\PersistentObject;

/**
 */
class PersistentCollectionTest extends \Shitty\Tests\OrmFunctionalTestCase
{
...
class PersistentCollectionHolder extends PersistentObject
{
    ...
    {
        $this->collection = new \Shitty\Common\Collections\ArrayCollection();
    }
