...
use Shitty\Tests\Models\DDC2504\DDC2504ChildClass;
use Shitty\Tests\Models\DDC2504\DDC2504OtherClass;
use Shitty\Tests\Models\Tweet\Tweet;
use Shitty\Tests\Models\Tweet\User;
use Shitty\Tests\Models\Tweet\UserList;
...
class ExtraLazyCollectionTest extends OrmFunctionalTestCase
{
    ...
    public function testCountWhenNewEntityPresent()
    {
        ...
        $newGroup = new \Shitty\Tests\Models\CMS\CmsGroup();
        $newGroup->name = "Test4";
    ...
    public function testContainsManyToManyInverse()
    {
        ...
        $newUser = new \Shitty\Tests\Models\CMS\CmsUser();
    ...
    {
        $user1 = new \Shitty\Tests\Models\CMS\CmsUser();
        $user1->username = "beberlei";
        $user1->name = "Benjamin";
        $user1->status = "active";

        $user2 = new \Shitty\Tests\Models\CMS\CmsUser();
        $user2->username = "jwage";
        $user2->name = "Jonathan";
        $user2->status = "active";

        $user3 = new \Shitty\Tests\Models\CMS\CmsUser();
        $user3->username = "romanb";
        $user3->name = "Roman";
        $user3->status = "active";

        $user4 = new \Shitty\Tests\Models\CMS\CmsUser();
        ...
        $group1 = new \Shitty\Tests\Models\CMS\CmsGroup();
        $group1->name = "Test1";

        $group2 = new \Shitty\Tests\Models\CMS\CmsGroup();
        $group2->name = "Test2";

        $group3 = new \Shitty\Tests\Models\CMS\CmsGroup();
        $group3->name = "Test3";
        ...
        $article1 = new \Shitty\Tests\Models\CMS\CmsArticle();
        $article1->topic = "Test1";
        $article1->text = "Test1";
        $article1->setAuthor($user1);

        $article2 = new \Shitty\Tests\Models\CMS\CmsArticle();
        ...
        $phonenumber1 = new \Shitty\Tests\Models\CMS\CmsPhonenumber();
        $phonenumber1->phonenumber = '12345';

        $phonenumber2 = new \Shitty\Tests\Models\CMS\CmsPhonenumber();
