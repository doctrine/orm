...
use Shitty\Tests\Models\CMS\CmsUser,
    Shitty\Tests\Models\CMS\CmsArticle,
    Shitty\Tests\Models\CMS\CmsPhonenumber;
 ...
 * @author robo
 */
class QueryTest extends \Shitty\Tests\OrmFunctionalTestCase
{
    ...
    /**
     * @expectedException \Shitty\ORM\Query\QueryException
     */
    ...
    public function testUnexpectedResultException()
    {
        ...
        } catch (\Shitty\ORM\UnexpectedResultException $exc) {
