...
use Shitty\Tests\Models\VersionedManyToOne\Article;
use Shitty\Tests\Models\VersionedManyToOne\Category;

/**
 * @group MergeVersionedOneToMany
 */
class MergeVersionedManyToOneTest extends \Shitty\Tests\OrmFunctionalTestCase
{
