...
use Shitty\Tests\Models\CMS\CmsArticle,
    Shitty\Tests\Models\CMS\CmsUser,
    Shitty\DBAL\LockMode,
    Shitty\ORM\EntityManager;

/**
 * @group locking
 */
class LockTest extends \Shitty\Tests\OrmFunctionalTestCase {
    ...
    public function testLockOptimisticNonVersionedThrowsExceptionInDQL()
    {
        ...
        $sql = $this->_em->createQuery($dql)->setHint(
          \Shitty\ORM\Query::HINT_LOCK_MODE, \Shitty\DBAL\LockMode::OPTIMISTIC
        )->getSQL();
    }
}
