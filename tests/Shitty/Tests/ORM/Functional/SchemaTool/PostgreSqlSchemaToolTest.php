...
namespace Shitty\Tests\ORM\Functional\SchemaTool;

use Shitty\ORM\Tools\SchemaTool,
    Shitty\ORM\Mapping\ClassMetadata;

class PostgreSqlSchemaToolTest extends \Shitty\Tests\OrmFunctionalTestCase
{
