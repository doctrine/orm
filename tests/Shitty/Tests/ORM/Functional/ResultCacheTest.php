 ...
 * @author robo
 */
class ResultCacheTest extends \Shitty\Tests\OrmFunctionalTestCase
{
   /**
    ...
    {
        $cache = new ArrayCache();
        $rsm   = new \Shitty\ORM\Query\ResultSetMapping();
    ...
    public function testResultCacheNotDependsOnHydrationMode($query)
    {
        ...
        $this->assertNotEquals(\Shitty\ORM\Query::HYDRATE_ARRAY, $query->getHydrationMode());
