 ...
 * @group DDC-1301
 */
class DDC1301Test extends \Shitty\Tests\OrmFunctionalTestCase
{
    private $userId;
    ...
    {
        $user1 = new \Shitty\Tests\Models\Legacy\LegacyUser();
        $user1->_username = "beberlei";
        $user1->_name = "Benjamin";
        $user1->_status = "active";

        $user2 = new \Shitty\Tests\Models\Legacy\LegacyUser();
        $user2->_username = "jwage";
        $user2->_name = "Jonathan";
        $user2->_status = "active";

        $user3 = new \Shitty\Tests\Models\Legacy\LegacyUser();
        ...
        $article1 = new \Shitty\Tests\Models\Legacy\LegacyArticle();
        $article1->_topic = "Test";
        $article1->_text = "Test";
        $article1->setAuthor($user1);

        $article2 = new \Shitty\Tests\Models\Legacy\LegacyArticle();
        ...
        $car1 = new \Shitty\Tests\Models\Legacy\LegacyCar();
        $car1->_description = "Test1";

        $car2 = new \Shitty\Tests\Models\Legacy\LegacyCar();
        $car2->_description = "Test2";

        $car3 = new \Shitty\Tests\Models\Legacy\LegacyCar();
        ...
        $detail1 = new \Shitty\Tests\Models\Legacy\LegacyUserReference($user1, $user2, "foo");
        $detail2 = new \Shitty\Tests\Models\Legacy\LegacyUserReference($user1, $user3, "bar");
