 ...
 * @group DDC-1430
 */
class DDC1430Test extends \Shitty\Tests\OrmFunctionalTestCase
{
...
class DDC1430Order
{
     ...
     *
     * @var \Shitty\Common\Collections\ArrayCollection $products
     */
    private $products;
    ...
    public function __construct($status)
    {
        ...
        $this->products = new \Shitty\Common\Collections\ArrayCollection();
    }
    /**
     * @return \DateTime
     */
