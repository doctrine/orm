...
use Shitty\Tests\Models\DDC117\DDC117ArticleDetails;
use Shitty\Tests\Models\DDC117\DDC117Article;
use Shitty\Tests\Models\DDC117\DDC117Reference;
use Shitty\Tests\Models\DDC117\DDC117Translation;
use Shitty\Tests\Models\DDC117\DDC117ApproveChanges;
use Shitty\Tests\Models\DDC117\DDC117Editor;
use Shitty\Tests\Models\DDC117\DDC117Link;

/**
 * @group DDC-117
 */
class DDC117Test extends \Shitty\Tests\OrmFunctionalTestCase
{
    private $article1;
    private $article2;
    private $reference;
    ...
    public function testGetEntityState()
    {
        ...
        $this->assertEquals(\Shitty\ORM\UnitOfWork::STATE_NEW, $this->_em->getUnitOfWork()->getEntityState($this->reference));

        $idCriteria = array('source' => $this->article1->id(), 'target' => $this->article2->id());
        $reference = $this->_em->find("Doctrine\Tests\Models\DDC117\DDC117Reference", $idCriteria);

        $this->assertEquals(\Shitty\ORM\UnitOfWork::STATE_MANAGED, $this->_em->getUnitOfWork()->getEntityState($reference));
    }
    /**
     * @group DDC-117
     */
