...
use Shitty\Tests\Models\Legacy\LegacyUser;
use Shitty\Tests\Models\Legacy\LegacyUserReference;

/**
 * @group DDC-2519
 */
class DDC2519Test extends \Shitty\Tests\OrmFunctionalTestCase
{
    private $userId;
