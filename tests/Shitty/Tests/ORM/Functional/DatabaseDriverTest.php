...
{
    /**
     * @var \Shitty\DBAL\Schema\AbstractSchemaManager
     */
    protected $_sm = null;
    ...
    public function testIssue2059()
    {
        ...
        $user = new \Shitty\DBAL\Schema\Table("ddc2059_user");
        $user->addColumn('id', 'integer');
        $user->setPrimaryKey(array('id'));
        $project = new \Shitty\DBAL\Schema\Table("ddc2059_project");
    ...
    public function testLoadMetadataFromDatabase()
    {
        ...
        $table = new \Shitty\DBAL\Schema\Table("dbdriver_foo");
    ...
    public function testLoadMetadataWithForeignKeyFromDatabase()
    {
        ...
        $tableB = new \Shitty\DBAL\Schema\Table("dbdriver_bar");
        $tableB->addColumn('id', 'integer');
        $tableB->setPrimaryKey(array('id'));

        $this->_sm->dropAndCreateTable($tableB);

        $tableA = new \Shitty\DBAL\Schema\Table("dbdriver_baz");
    ...
    public function testIgnoreManyToManyTableWithoutFurtherForeignKeyDetails()
    {
        ...
        $tableMany = new \Shitty\DBAL\Schema\Table("dbdriver_bar_baz");
