 ...
 * @group DDC-952
 */
class OneToOneEagerLoadingTest extends \Shitty\Tests\OrmFunctionalTestCase
{
    protected function setUp()
    {
        parent::setUp();
        $schemaTool = new \Shitty\ORM\Tools\SchemaTool($this->_em);
        try {
...
class Train
{
    ...
    {
        $this->waggons = new \Shitty\Common\Collections\ArrayCollection();
        $this->setOwner($owner);
    }
