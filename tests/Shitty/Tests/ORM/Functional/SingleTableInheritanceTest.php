...
class SingleTableInheritanceTest extends \Shitty\Tests\OrmFunctionalTestCase
{
    private $salesPerson;
    ...
    public function loadFullFixture()
    {
        ...
        $this->fix = new \Shitty\Tests\Models\Company\CompanyFixContract();
        ...
        $this->flex = new \Shitty\Tests\Models\Company\CompanyFlexContract();
        ...
        $this->ultra = new \Shitty\Tests\Models\Company\CompanyFlexUltraContract();
    ...
    public function testPersistChildOfBaseClass()
    {
        ...
        $fixContract = new \Shitty\Tests\Models\Company\CompanyFixContract();
    ...
    public function testPersistDeepChildOfBaseClass()
    {
        ...
        $ultraContract = new \Shitty\Tests\Models\Company\CompanyFlexUltraContract();
