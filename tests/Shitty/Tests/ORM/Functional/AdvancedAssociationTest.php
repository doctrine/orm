 ...
 * @author robo
 */
class AdvancedAssociationTest extends \Shitty\Tests\OrmFunctionalTestCase
{
...
class Lemma {
	...
	public function __construct() {
		$this->types = new \Shitty\Common\Collections\ArrayCollection();
	}
...
class Type {
	...
	public function __construct(){
		$this->lemmas = new \Shitty\Common\Collections\ArrayCollection();
	}
...
class Phrase {
    ...
    public function __construct() {
        $this->definitions = new \Shitty\Common\Collections\ArrayCollection;
    }
...
class PhraseType {
    ...
    public function __construct() {
        $this->phrases = new \Shitty\Common\Collections\ArrayCollection;
    }
