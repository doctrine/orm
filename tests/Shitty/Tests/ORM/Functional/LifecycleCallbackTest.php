...
class LifecycleCallbackTest extends \Shitty\Tests\OrmFunctionalTestCase
{
...
class LifecycleCallbackCascader
{
    ...
    {
        $this->entities = new \Shitty\Common\Collections\ArrayCollection();
    }
...
class LifecycleCallbackEventArgEntity
{
     ...
     * @PostPersist
     */
    public function postPersistHandler(\Shitty\ORM\Event\LifecycleEventArgs $event)
    {
     ...
     * @PrePersist
     */
    public function prePersistHandler(\Shitty\ORM\Event\LifecycleEventArgs $event)
    {
        $this->calls[__FUNCTION__] = $event;
    }
     ...
     * @PostUpdate
     */
    public function postUpdateHandler(\Shitty\ORM\Event\LifecycleEventArgs $event)
    {
        $this->calls[__FUNCTION__] = $event;
    }
     ...
     * @PreUpdate
     */
    public function preUpdateHandler(\Shitty\ORM\Event\PreUpdateEventArgs $event)
    {
        $this->calls[__FUNCTION__] = $event;
    }
     ...
     * @PostRemove
     */
    public function postRemoveHandler(\Shitty\ORM\Event\LifecycleEventArgs $event)
    {
        $this->calls[__FUNCTION__] = $event;
    }
     ...
     * @PreRemove
     */
    public function preRemoveHandler(\Shitty\ORM\Event\LifecycleEventArgs $event)
    {
        $this->calls[__FUNCTION__] = $event;
    }
     ...
     * @PreFlush
     */
    public function preFlushHandler(\Shitty\ORM\Event\PreFlushEventArgs $event)
    {
        $this->calls[__FUNCTION__] = $event;
    }
     ...
     * @PostLoad
     */
    public function postLoadHandler(\Shitty\ORM\Event\LifecycleEventArgs $event)
    {
        $this->calls[__FUNCTION__] = $event;
    }
}
