...
class Configuration extends \Doctrine\DBAL\Configuration
{
    ...
    /** @var int<1, max> */
    private int $persisterMaximumInsertBatchSize = 1;
    ...
    /**
     * Maximum amount of `VALUES` to be generated by entity persisters: allows reducing the amount
     * of INSERT DML queries sent to the database, in exchange for larger INSERT DML size.
     *
     * By default, the ORM will produce:
     *
     * `INSERT INTO <table> (<fields>) VALUES (values)`
     *
     * By raising this value, the ORM will attempt to generate multiple values, where possible:
     *
     * `INSERT INTO <table> (<fields>) VALUES (values1), (values2), (values3)`
     *
     * Remember that the maximum batch size depends on your underlying SQL driver, as well of number
     * of entity fields and size of data that you wish to send to the database.
     *
     * @param int<1, max> $persisterMaximumInsertBatchSize
     */
    public function setPersisterMaximumInsertBatchSize(int $persisterMaximumInsertBatchSize): void
    {
        $this->persisterMaximumInsertBatchSize = $persisterMaximumInsertBatchSize;
    }

    /** @return int<1, max> */
    public function getPersisterMaximumInsertBatchSize(): int
    {
        return $this->persisterMaximumInsertBatchSize;
    }
}
