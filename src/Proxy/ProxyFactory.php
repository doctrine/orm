...
class ProxyFactory
{
     ...
     */
    final public const int AUTOGENERATE_NEVER = 0;
     ...
     */
    final public const int AUTOGENERATE_ALWAYS = 1;
     ...
     */
    final public const int AUTOGENERATE_FILE_NOT_EXISTS = 2;
     ...
     * the creeps a little.
     */
    final public const int AUTOGENERATE_EVAL = 3;
     ...
     * be updated.
     */
    final public const int AUTOGENERATE_FILE_NOT_EXISTS_OR_CHANGED = 4;

    private const string PROXY_CLASS_TEMPLATE = <<<'EOPHP'
<?php
